...
-   [ ] Quand une URL contenant des paramètres dans sa QueryString est chargée, il faut que toutes les informations présentes dans l'URL soient appliquées dans la page chargée _(Si l'URL contient `taille=8`, il faut que le champ taille affiche la valeur **8**)_
